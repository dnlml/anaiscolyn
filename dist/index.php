    ...
    <article class="article about" id="about">
      ...
      <div class="flexy">
        ...
        <div class="about__img__wrapper card__wrapper">
          <div class="about__img__gradient"></div>
          <img src="assets/images/ac.jpg" alt="Image of Anaïs Colyn" class="about__img__thumb">
          <span class="about__img__light card__light"></span>
        </div>
        </div>
    ...
    <article class="article skills">
      ...
      <div class="skills__block flexy">
        <dl class="skills__block__item flexy__item">
          ...
          <dd>Autocad 2d</dd>
          <dd>Sketchup</dd>
          <dd>Microsoft (Word, Powerpoint)</dd>
